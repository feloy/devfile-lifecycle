...
sync-all-my-container -->|"sources synced"| my-build-2
sync-all-my-container -->|"sources synced"| my-build-3
my-build-1 -->|"build done, with run"| my-run
my-build-2 -->|"build done, with run"| my-run
...
sync-modified-my-container -->|"source synced"| my-build-2
sync-modified-my-container -->|"source synced"| my-build-3
